...
#     my_list_2 = ['有林地', '灌木林地', '疏林地', '幼林地', '其他林地']
...
#
#         self.color_manager = QtColorPropertyManager(self)
#         self.color = self.color_manager.addProperty('标注颜色')
#         self.color_manager.valueChangedSignal.connect(self.color_changed)
#
...
#         self.__create_color(self.__mark_item.color)
...
#
#     def __create_color(self, data_color):
#         self.color_manager.setValue(self.color, data_color)
#
...
#         color_fictory = QtColorEditorFactory()
...
#         browser.setFactoryForManager(self.color_manager, color_fictory)
...
#         browser.addProperty(self.color)
